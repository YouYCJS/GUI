...
window.geometry("1540x885") #창크기 제목
window.resizable(False,False)
font=tkinter.font.Font(family="맑은 고딕", size=20, slant="roman", weight="bold") #폰트 설정
font_btn=tkinter.font.Font(family="맑은 고딕",size=50,slant="roman",weight="bold") #버튼 글씨색
font_btn2=tkinter.font.Font(family="맑은 고딕",size=45,slant="roman",weight="bold") #버튼 글씨색
font_btn4=tkinter.font.Font(family="맑은 고딕",size=23,slant="roman",weight="bold") #버튼 글씨색
...
def btn_5(): #주류 물품 안내
    ...
    btn_life=tkinter.Button     (newWindow5,text="수산물/건해산",overrelief="solid",relief="solid",borderwidth=3,background="blue",foreground="white",width=26,height=4,font=font_btn4,activebackground="MediumPurple1",highlightthickness=3)#,command=btn_lif)
